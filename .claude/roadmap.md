...
Phase B — 3D 1v1, both boxers LLM-controlled
  ...
  B3 Tune energy/damage/timing config against B2 fights; lengthen rounds toward 2 min
  B4 Knockdowns + 10-count, multi-round matches, between-round rest recovery (ratchet caps lift)
Deferred: separate head/body health bars, distinct boxer stats/styles, two-pass decisions
